package com.anisha.UserServiceF.security;

import com.anisha.UserServiceF.security.models.CustomUserDetails;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http)
        ...
        http
                .securityMatcher("/oauth2/**") // match only auth server endpoints
            ...
            if (OAuth2TokenType.ACCESS_TOKEN.equals(context.getTokenType())) {
                ...
                if (authentication != null) {
                    ...
                    Set<String> roles = AuthorityUtils.authorityListToSet(authentication.getAuthorities())
                            .stream()
                            .map(c -> c.replaceFirst("^ROLE_", "")) // remove ROLE_ prefix if present
                    ...
                    if (principal instanceof CustomUserDetails user) {
                        ...
                        context.getClaims().claim("email", user.getUsername()); // add email
